...
//create elements
function create(type, attr2, style) {
  let div = document.createElement(type);
  div.setAttribute('class', attr2);
...
function appendElements() {
  ...
  // <div class="background" style="position:fixed;height:100vh;width:100vw;z-index:351;left:0;top:0;overflow:none;"></div>
  ...
  var div = create('div', 'userscript-background', 'position:fixed;height:100vh;width:100vw;z-index:16777271;left:0;top:0;overflow:none;'); //z-index set to max (24-bit value)
  var inspire = create('div', 'userscript-inspire-content', 'display: block;text-align: center;padding-top: 50px;text-align: center;z-index:352;font-weight: 900;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;')
  var quote = create('div', 'userscript-quote-message', 'color: white;font-family: Montserrat, "Helvetica Neue", Helvetica, Arial, sans-serif;font-size: 2.5vw;margin-left: 10%;margin-right: 10%; margin-top: 10%;');

  inspire.append(quote);
  div.append(inspire);
...
function randomQuote() {
  ...
  document.getElementsByClassName('userscript-quote-message')[0].innerHTML = quote_div;
};
...
function randomGradient() {
  ...
  document.getElementsByClassName('userscript-background')[0].style.background = gradient;
};
...
function randomImage() {
  ...
  img2.onload = function() {
    this.setAttribute('style', 'position:fixed;top:0;left:0;width:100%;height:100%;');
    document.getElementsByClassName('userscript-background')[0].appendChild(this);
  }
  img2.src = 'https://source.unsplash.com/random/'+w+'x'+h+'/?'+keyword;
};
